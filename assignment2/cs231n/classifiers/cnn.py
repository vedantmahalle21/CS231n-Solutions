...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #conv_cache, relu1_cache, pool_cache = cache1
        Z2, cache2 = affine_relu_forward(Z1, W2, b2)
        #layer_cache, relu2_cache = cache2
        scores, fc_cache = affine_forward(Z2, W3, b3)
        ...
        loss += self.reg*np.sum(W1*W1) + self.reg*np.sum(W2*W2) + self.reg*np.sum(W3*W3)

        dout1, grads['W3'], grads['b3'] = affine_backward(dscores, fc_cache)
